...
const HELP_OPTIONS = [
  { id: 'invest_for_me', text: 'Invest for me', emoji: '💰' },
  { id: 'teach_me', text: 'Teach me about investing', emoji: '📘' },
  { id: 'self_invest', text: 'Let me invest on my own', emoji: '📈' },
  { id: 'insights', text: 'Personalized investing insights', emoji: '💡' },
  { id: 'unknown', text: 'I don’t know yet', emoji: '🤷‍♀️' },
];

// Using "Rachel" - High energy, clear
const ELEVEN_LABS_VOICE_ID = "21m00Tcm4TlvDq8ikWAM"; 
const VOICE_TEXT = "What are you hoping we can help you with in your financial journey?";

export const HelpOptionsScreen: React.FC<HelpOptionsScreenProps> = ({ onContinue }) => {
  ...
  const toggleOption = (id: string) => {
    if (selectedOptions.includes(id)) {
      ...
      // Append to maintain order of selection
